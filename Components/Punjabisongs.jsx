...
const Punjabisongs = () => {
  ...
  const hasScroll = punjabisongs.length > 6;
  ...
  return (
    <section style={containerStyle}>
      ...
      <div style={scrollerShellStyle}>
          ...
          {punjabisongs.map((song) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                const overlay =
                  e.currentTarget.querySelector(".ps-overlay");
                const img = e.currentTarget.querySelector(".ps-cover-img");
            ...
            >
              <div style={imgContainerStyle}>
                ...
                />
                <div className="ps-overlay" style={overlayStyle}>
        ...
        {punjabisongs.length === 0 && (
          <p style={noDataStyle}>
            No Punjabi songs to display yet. Check back later for updates.
          </p>
        )}
      </div>
    </section>
