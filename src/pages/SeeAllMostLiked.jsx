      ...
      <div className="pt-24 px-8 pb-20">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-4xl font-bold text-white">Most Liked</h1>
          </div>
          <p className="text-gray-400 mt-2 ml-8">Songs loved by everyone</p>
        </div>
...
export default SeeAllMostLiked;
