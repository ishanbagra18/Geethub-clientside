      ...
      <div className="pt-24 px-8 pb-20">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-4xl font-bold text-white">Punjabi Songs</h1>
          </div>
          <p className="text-gray-400 mt-2 ml-8">Popular Punjabi music collection</p>
        </div>

        {/* Songs Grid */}
        {loading.punjabiSongs ? (
          <div className="text-center text-gray-400 py-20">Loading songs...</div>
        ) : (sections.punjabiSongs || []).length === 0 ? (
          <div className="text-center text-gray-400 py-20">No songs found</div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6">
            {(sections.punjabiSongs || []).map((song) => (
              <div
...
export default SeeAllPunjabiSongs;
